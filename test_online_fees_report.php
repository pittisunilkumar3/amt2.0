...
echo "========================================\n";
echo "ONLINE FEES REPORT API - TEST SUITE\n";
echo "========================================\n\n";

// Test 1: List endpoint
echo "Test 1: List Endpoint\n";
echo "---------------------\n";
$url = $base_url . '/online-fees-report/list';
$ch = curl_init($url);
...
echo "----------------------------------------\n";
$url = $base_url . '/online-fees-report/filter';
$ch = curl_init($url);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLOPT_POST, true);
curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
...
echo "========================================\n";
echo "ONLINE FEES REPORT API: TEST COMPLETE\n";
echo "========================================\n";
