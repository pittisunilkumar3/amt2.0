<?php
/**
 * Test Expense Group Report API
 * Tests graceful null/empty handling and response structure
 */

$url_filter = 'http://localhost/amt/api/expense-group-report/filter';
$url_list = 'http://localhost/amt/api/expense-group-report/list';
$headers = [
...
echo "==============================================\n";
echo "EXPENSE GROUP REPORT API - COMPREHENSIVE TEST\n";
echo "==============================================\n\n";
...
if (json_last_error() === JSON_ERROR_NONE) {
    ...
    if (isset($json_data['data'])) {
        echo "Expense Heads: " . (isset($json_data['data']['expense_heads']) ? count($json_data['data']['expense_heads']) : 0) . "\n";
...
// Test 2: Empty Request (Should return all expenses for current year)
