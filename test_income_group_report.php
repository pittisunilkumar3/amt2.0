...
echo "========================================\n";
echo "INCOME GROUP REPORT API - TEST SUITE\n";
echo "========================================\n\n";

// Test 1: List endpoint
echo "Test 1: List Endpoint\n";
echo "---------------------\n";
$url = $base_url . '/income-group-report/list';
$ch = curl_init($url);
...
if (json_last_error() === JSON_ERROR_NONE) {
    ...
    if (isset($json_data['data']['income_heads'])) {
        echo "Income Heads Count: " . count($json_data['data']['income_heads']) . "\n";
    }
...
echo "----------------------------------------\n";
$url = $base_url . '/income-group-report/filter';
$ch = curl_init($url);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLOPT_POST, true);
curl_setopt($ch, CURLOPT_HTTPHEADER, $headers);
...
echo "========================================\n";
echo "INCOME GROUP REPORT API: TEST COMPLETE\n";
echo "========================================\n";
