...
class MY_Controller extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        // Early session check to redirect to login before database operations if session expired
        if ($this instanceof Admin_Controller && !$this->session->has_userdata('admin')) {
            redirect('site/login');
        } else if ($this instanceof Student_Controller && !$this->session->has_userdata('student')) {
            redirect('site/userlogin');
        } else if ($this instanceof Parent_Controller && !$this->session->has_userdata('parent')) {
            redirect('site/userlogin');
        }
        ...
        if ($this->session->has_userdata('admin')) {
            ...
            try {
                ...
                $language             = ($this->school_details) ? $this->school_details->language : 'english';
            } catch (Exception $e) {
                $language = 'english';
            }
        }
