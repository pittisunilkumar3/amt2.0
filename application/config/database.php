...
$port = isset($mydb['port']) ? $mydb['port'] : 3306;

// Suppress mysqli exceptions for this manual check
$driver = new mysqli_driver();
$driver->report_mode = MYSQLI_REPORT_OFF;

$mysqli = @new mysqli($mydb['hostname'], $mydb["username"], $mydb["password"], $mydb["database"], $port);
