...
class Setting_model extends MY_Model {
    ...
    public function get_receipt_template() {
        $image = $this->db->select('receipt_template')->from('print_headerfooter')->where('print_type', 'student_receipt')->get()->row_array();
        return $image['receipt_template'];
    }

    public function get_receipt_header_content() {
        $image = $this->db->select('header_content')->from('print_headerfooter')->where('print_type', 'student_receipt')->get()->row_array();
        return $image['header_content'];
    }
    ...
    public function get_payslip_template() {
        $image = $this->db->select('receipt_template')->from('print_headerfooter')->where('print_type', 'staff_payslip')->get()->row_array();
        return $image['receipt_template'];
    }

    public function get_payslip_header_content() {
        $image = $this->db->select('header_content')->from('print_headerfooter')->where('print_type', 'staff_payslip')->get()->row_array();
        return $image['header_content'];
    }
