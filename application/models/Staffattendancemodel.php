...
class Staffattendancemodel extends MY_Model {
    ...
    /**
     * Get all attendance records for a staff member on a specific day
     * Used to calculate total hours worked (first check-in to last check-out)
     */
    public function getStaffDayAttendance($staff_id, $date) {
        $this->db->select('staff_attendance.id, staff_attendance.staff_id, staff_attendance.date, 
                          staff_attendance.check_in_time, staff_attendance.check_out_time, 
                          staff_attendance.created_at, staff_attendance.staff_attendance_type_id,
                          staff_attendance_type.type as att_type, staff_attendance_type.key_value');
        ...
        $this->db->order_by('staff_attendance.created_at', 'ASC');
