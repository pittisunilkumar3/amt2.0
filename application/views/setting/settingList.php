        ...
        <div class="row">
            ...
            <div class="col-md-10">            
                ...
                <div class="box box-primary">                    
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <div class="alert alert-info">Note: After saving General Setting please once logout then relogin so changes will be come in effect.</div>
                        </div>
                    </div>            
            
                    <div class="">
                        <form role="form" id="schsetting_form" action="<?php //echo site_url('schsettings/ajax_schedit_new'); ?>" class="material-form" method="post" enctype="multipart/form-data">
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea class="form-control" id="address" name="sch_address" rows="2"><?php echo $result->address; ?></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label class="col-sm-5"><?php echo $this->lang->line('start_day_of_week') ?><small class="req"> *</small></label>
                                            <div class="col-sm-7">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            <label class="col-sm-4"><?php echo $this->lang->line('file_upload_path'); ?><small class="req"> *</small></label>
                                       <div class="col-sm-8">
