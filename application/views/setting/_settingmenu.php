<div class="col-md-2">
    <div class="box border0">
        <ul class="tablists">
            ...
            <li class="<?php echo set_SubSubmenu('schsettings/themecolour'); ?>">
                <a class="<?php echo set_SubSubmenu('schsettings/themecolour'); ?>" href="<?php echo site_url('schsettings/themecolour') ?>"><?php echo $this->lang->line('theme_colour'); ?></a>
            </li>
            ...
            <!--Bio metric menu added -->
            <li class="<?php echo set_SubSubmenu('schsettings/biometricsetting'); ?>">
                <a class="<?php echo set_SubSubmenu('schsettings/biometricsetting'); ?>" href="<?php echo site_url('schsettings/biometricsetting') ?>"><?php echo $this->lang->line('biometricsetting'); ?></a>
            </li>

            <!--Biometric Timing Assignment menu added -->
            <li class="<?php echo set_SubSubmenu('admin/time_range_assignment'); ?>">
                <a class="<?php echo set_SubSubmenu('admin/time_range_assignment'); ?>" href="<?php echo site_url('admin/time_range_assignment') ?>"><?php echo $this->lang->line('biometric_timing_assignment'); ?></a>
            </li>
            ...
            <li class="<?php echo set_SubSubmenu('schsettings/whatsappsettings'); ?>">
                <a class="<?php echo set_SubSubmenu('schsettings/whatsappsettings'); ?>" href="<?php echo site_url('schsettings/whatsappsettings') ?>">
                    <i class="fa fa-whatsapp" style="color: #25D366;"></i> <?php echo $this->lang->line('whatsapp_settings'); ?>
                </a>
            </li>
