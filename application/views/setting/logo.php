            ...
            <div class="col-md-10">
                <div class="box box-primary">
                    <div class="box-header ptbnull">
                        <h3 class="box-title titlefix"><i class="fa fa-picture-o"></i> <?php echo $this->lang->line('logo'); ?></h3>
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.success) {
                    ...
                    var errMsg = response.error.file || response.message || 'Unknown error';
            ...
            error: function (xhr, status, errorThrown) {
                ...
                errorMsg('Upload failed: ' + (errorThrown || status || 'Server error'));
            },
            complete: function () {
