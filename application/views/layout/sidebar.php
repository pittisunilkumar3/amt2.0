<aside class="main-sidebar" id="alert2">
    <?php if ($this->rbac->hasPrivilege('student', 'can_view')) { ?>
        <!-- Sidebar/mobile student search: wire it exactly like header search -->
        <form class="navbar-form navbar-left search-form2" role="search" action="<?php echo site_url('admin/admin/searchhole'); ?>" method="POST">
            <?php echo $this->customlib->getCSRF(); ?>
            <div class="input-group ">

                <input type="text" name="search_text2" id="search_text2" class="form-control search-form" placeholder="<?php echo $this->lang->line('search_by_student_name'); ?>">
            ...
            ?>
                            ...
                            <li class="treeview <?php echo activate_main_menu($side_list_value->activate_menu); ?>">
                                ...
                                <a href="#">
                                    ...
                                    <span<?php echo (strlen($menu_label) > 13 ? ' title="' . htmlspecialchars($menu_label, ENT_QUOTES, 'UTF-8') . '"' : ''); ?>>
                                        <?php echo $menu_label; ?>
                                    </span>
                                    ...
                                    <ul class="treeview-menu">
                                        ...
                                        foreach ($side_list_value->submenus as $submenu_key => $submenu_value) {
                                            ...
                                            if ($sidebar_access) {
                                                ...
                                                $submenu_label = $this->lang->line($submenu_value->lang_key);

                                        ?>

                                                <li class="<?php echo activate_submenu($submenu_value->activate_controller, explode(',', $submenu_value->activate_methods), 'active', $submenu_value->url); ?>">
                                                    <a href="<?php echo site_url($submenu_value->url); ?>">
                                                        <i class="fa fa-angle-double-right"></i><span<?php echo (strlen($submenu_label) > 20 ? ' title="' . htmlspecialchars($submenu_label, ENT_QUOTES, 'UTF-8') . '"' : ''); ?>>
                                                            <?php echo $submenu_label; ?>
                                                        </span>
                                                    </a>
                                                </li>
