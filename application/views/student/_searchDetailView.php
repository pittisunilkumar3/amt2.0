            ...
            <div class="slide-row">
                ...
                <div class="slide-footer">
                    <span class="pull-right buttons">
                        <a href="<?php echo base_url(); ?>student/view/<?php echo $student->id ?>" class="btn btn-view btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('view'); ?>">
                            <i class="fa fa-eye"></i>
                        </a>
                        <?php
                        if ($this->rbac->hasPrivilege('student', 'can_edit')) {
                        ?>
                            <a href="<?php echo base_url(); ?>student/edit/<?php echo $student->id ?>" class="btn btn-edit btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
                        ...
                        ?>
                            <a href="<?php echo base_url(); ?>studentfee/addfee/<?php echo $student->student_session_id ?>" class="btn btn-collect btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('add_fees'); ?>">
