                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input id="admi_no" name="admi_no" placeholder="" type="text" class="form-control"  value="<?php echo set_value('admi_no', $admi_no); ?>" />
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <?php if (!empty($student['image'])) { ?>
                                                        <img src="<?php echo $this->customlib->getBaseUrl() . $student['image']; ?>" id="student_photo_preview" style="max-width:60px; max-height:60px; margin-bottom:5px; border:1px solid #ddd; border-radius:4px;">
                                                    <?php } else { ?>
                                                        <img id="student_photo_preview" src="#" alt="Preview" style="display:none; max-width:60px; max-height:60px; margin-bottom:5px; border:1px solid #ddd; border-radius:4px;">
                                                    <?php } ?>
                                                    <input class="filestyle form-control" type='file' name='file' id="student_photo_file" size='20' accept="image/*" onchange="previewImage(this, 'student_photo_preview')"/>
                                                    </div>
                                    ...
                                    <div class="row around10">
                                                    ...
                                                    <select autofocus="" id="reference_id" name="reference_id" class="form-control select2" >
                                                        ...
                                                        <?php
                                                            ...
                                                            <option value="<?php echo $staff['id']; ?>" <?php
                                                                if (!empty($stafff) && $stafff['id'] == $staff['id']) {
                                                                    echo "selected";
                                                                }
                                                                ?>><?php echo $staff['name'] . " " . $staff['surname']; ?>(<?php echo $staff['designation']; ?>)
                                                            </option>
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <p class="text-muted" style="font-size:12px; margin-bottom:5px;"><i class="fa fa-info-circle"></i> Only PDF files are accepted</p>
                                                    <?php if (!empty($application_doc) && !empty($application_doc->file_path)) { ?>
                                                        <div class="alert alert-success" style="padding:8px 12px; margin-bottom:5px;">
                                                            <i class="fa fa-file-pdf-o"></i> Existing document uploaded
                                                            <a href="<?php echo site_url('admin/content/view_pdf/' . $id); ?>" target="_blank" class="btn btn-xs btn-default" style="margin-left:5px;"><i class="fa fa-eye"></i> View</a>
                                                            <a href="<?php echo site_url('admin/content/download_student_application/' . $id); ?>" class="btn btn-xs btn-default" style="margin-left:3px;"><i class="fa fa-download"></i> Download</a>
                                                        </div>
                                                        <p class="text-muted" style="font-size:11px;"><i class="fa fa-info-circle"></i> Upload a new file to replace the existing document</p>
                                                    <?php } ?>
                                                    <div class="input-group">
                                                        <label class="input-group-btn" style="vertical-align:top;">
                                                            <span class="btn btn-default btn-file">
                                                                <i class="fa fa-upload"></i> Browse&hellip;
                                                                <input type="file" name="apply_doc" id="apply_doc" accept=".pdf,application/pdf" style="display:none;">
                                                            </span>
                                                        </label>
                                                        <input type="text" class="form-control" readonly id="apply_doc_name" placeholder="<?php echo (!empty($application_doc) && !empty($application_doc->file_path)) ? 'Current document uploaded (upload to replace)' : 'No file chosen'; ?>">
                                                    </div>
                                                    <div id="apply_doc_preview" class="alert alert-info" style="display:none; margin-top:8px; padding:8px 12px;">
                                                        <i class="fa fa-file-pdf-o"></i> <span id="apply_doc_preview_name"></span>
                                                        <button type="button" class="close" style="margin-left:10px;" onclick="clearApplyDoc()" title="Remove">&times;</button>
                                                    </div>
...
// print_r($transport_fees);
                                                                 ?>
                                                              <select id="specialistOpt" class="form-control multiselect-dropdown" id="transport_feemaster_id" name="transport_feemaster_id[]" multiple="multiple" >
                                                     <?php
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <?php if (!empty($student['father_pic'])) { ?>
                                                        <img src="<?php echo $this->customlib->getBaseUrl() . $student['father_pic']; ?>" id="father_photo_preview" style="max-width:60px; max-height:60px; margin-bottom:5px; border:1px solid #ddd; border-radius:4px;">
                                                    <?php } else { ?>
                                                        <img id="father_photo_preview" src="#" alt="Preview" style="display:none; max-width:60px; max-height:60px; margin-bottom:5px; border:1px solid #ddd; border-radius:4px;">
                                                    <?php } ?>
                                                    <input class="filestyle form-control" type='file' name='father_pic' id="father_pic" size='20' accept="image/*" onchange="previewImage(this, 'father_photo_preview')" />
                                                    </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <?php if (!empty($student['mother_pic'])) { ?>
                                                        <img src="<?php echo $this->customlib->getBaseUrl() . $student['mother_pic']; ?>" id="mother_photo_preview" style="max-width:60px; max-height:60px; margin-bottom:5px; border:1px solid #ddd; border-radius:4px;">
                                                    <?php } else { ?>
                                                        <img id="mother_photo_preview" src="#" alt="Preview" style="display:none; max-width:60px; max-height:60px; margin-bottom:5px; border:1px solid #ddd; border-radius:4px;">
                                                    <?php } ?>
                                                    <input class="filestyle form-control" type='file' name='mother_pic' id="mother_pic" size='20' accept="image/*" onchange="previewImage(this, 'mother_photo_preview')" />
                                                    </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <?php if (!empty($student['guardian_pic'])) { ?>
                                                        <img src="<?php echo $this->customlib->getBaseUrl() . $student['guardian_pic']; ?>" id="guardian_photo_preview" style="max-width:60px; max-height:60px; margin-bottom:5px; border:1px solid #ddd; border-radius:4px;">
                                                    <?php } else { ?>
                                                        <img id="guardian_photo_preview" src="#" alt="Preview" style="display:none; max-width:60px; max-height:60px; margin-bottom:5px; border:1px solid #ddd; border-radius:4px;">
                                                    <?php } ?>
                                                    <input class="filestyle form-control" type='file' name='guardian_pic' id="guardian_pic" size='20' accept="image/*" onchange="previewImage(this, 'guardian_photo_preview')" />
                                                    </div>
...
<script type="text/javascript">
    ...
    function previewImage(input, previewId) {
        ...
        if (input.files && input.files[0]) {
            ...
            // Don't hide if there's already an existing photo
            if (preview.src && preview.src !== window.location.href && preview.style.display !== 'none') {
                // Keep existing photo visible
            } else {
