...
<div class="content-wrapper student-profile-page">
                                            ...
                                            <a class="" href="<?php echo base_url() . "student/view/" . $stvalue["id"] ?>">
                                                <div class="icon">
                                                    <?php if ($sch_setting->student_photo) {
                                                        ?>
                                                        <img src="<?php
                                                        if (!empty($stvalue["image"]) && file_exists(FCPATH . $stvalue["image"])) {
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary staff-profile-header" <?php
                ...
                ?>>
                    <div class="box-body box-profile">
                        <?php
                        if (!empty($student["image"]) && file_exists(FCPATH . $student["image"])) {
                            ...
                            <div class="staff-header-left">
                                ...
                                <div class="staff-header-main">
                                    ...
                                    <div class="staff-header-meta">
                                        <div class="staff-header-meta-item">
                                            <span class="label-text"><?php echo $this->lang->line('application_no') ? $this->lang->line('application_no') : 'Application No'; ?></span>
                                            <span class="value-text"><?php echo $student['admission_no']; ?></span>
                                        </div>
                                    </div>

                                    <div class="staff-header-badges">
                                        <span class="staff-role-badge"><?php echo $this->lang->line('student') ? $this->lang->line('student') : 'Student'; ?></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="staff-header-actions">
                                <?php if ($student["is_active"] == "yes") { ?>
                                    ...
                                    if ($this->rbac->hasPrivilege('student', 'can_edit')) {
                                        ?>
                                        <a href="<?php echo base_url() . "student/edit/" . $student["id"] ?>" class="staff-action-btn text-light"
                                    ...
                                    if ($this->module_lib->hasActive('fees_collection')) {
                                        ?>
                                        <a href="<?php echo site_url('studentfee/addfee/' . $student["student_session_id"]) ?>" class="staff-action-btn"
                                            data-toggle="tooltip" data-placement="bottom"
                                            title="<?php echo $this->lang->line('collect_fees'); ?>">
                                    ...
                                    if ($this->rbac->hasPrivilege('student_login_credential_report', 'can_view')) {
                                        ?>
                                        <a href="#" class="staff-action-btn schedule_modal text-green" data-toggle="tooltip"
                                            data-placement="bottom"
                                            title="<?php echo $this->lang->line('login_details'); ?>">
                                            <i class="fa fa-key"></i>
                                        </a>
                                        <?php
                                    }
                                    if ($this->rbac->hasPrivilege('disable_student', 'can_view')) {
                                        ...
                                        <a style="cursor: pointer;" onclick="disable_student('<?php echo $student["id"] ?>')"
                                            class="staff-action-btn text-red" data-toggle="tooltip" data-placement="bottom"
                                            title="<?php echo $this->lang->line("disable"); ?>">
                                            <i class="fa fa-thumbs-o-down"></i>
                                        </a>
                                        <div class="dropdown rtl-dropdown" style="display:inline-block;">
                                            <a href="#" class="dropdown-toggle" type="button" data-toggle="dropdown">
                                                <i class="fa fa-ellipsis-v"></i>
                                            </a>
                                            <ul class="dropdown-menu">
                                                <li><a style="cursor: pointer;" onclick="send_password()">
                                                        <?php echo $this->lang->line('send_student_password'); ?></a>
                                                </li>
                                                <li><a style="cursor: pointer;" onclick="send_parent_password()">
                                                        <?php echo $this->lang->line('send_parent_password'); ?></a>
                                                </li>
                                            </ul>
                                        </div>
                                        <?php
                                    ...
                                    ?>
                                    <a href="#" onclick="enable('<?php echo $student["id"] ?>')" class="staff-action-btn text-green"
                        ...
                        <ul class="list-group list-group-unbordered">
                            <?php if(isset($student['admi_no']) && !empty($student['admi_no'])): ?>
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('admi_no'); ?></b> <span
                                    class="pull-right text-aqua"><?php echo $student['admi_no']; ?></span>
                            </li>
                            <?php endif; ?>
                            <li class="list-group-item listnoback">
                                <b><?php echo $this->lang->line('roll_number'); ?></b> <span
                                    class="pull-right text-aqua"><?php echo $student['roll_no']; ?></span>
                            </li>
                ...
                <?php
                if (!empty($siblings)) {
                    // Debug siblings data - uncomment to see the data structure
                    // echo "<pre>Debug Siblings: "; print_r($siblings); echo "</pre>";
                    ?>
                                ...
                                <div class="widget-user-header bg-gray-light overflow-hidden">
                                    <div class="widget-user-image">
                                        ...
                                        if (!empty($sibling_value->image)) {
                                            $sibling_image_basename = basename($sibling_value->image);
                                            if ($sibling_image_basename === 'default_male.jpg' || $sibling_image_basename === 'default_female.jpg') {
                                                if ($sibling_value->gender == 'Male') {
                                                    echo $this->media_storage->getImageURL("uploads/staff_images/default_male.jpg");
                                                } else {
                                                    echo $this->media_storage->getImageURL("uploads/staff_images/default_female.jpg");
                                                }
                                    ...
                                    <div class="no-padding">
                                        <ul class="list-group list-group-unbordered">
                                            ...
                                            <li class="list-group-item">
                                                <b><?php echo $this->lang->line('admission_no'); ?></b> <span
                                                    class="pull-right text-aqua"><?php echo $sibling_value->admission_no; ?></span>
                                            </li>
                                            <?php if(isset($sibling_value->admi_no) && !empty($sibling_value->admi_no)): ?>
                                            <li class="list-group-item">
                                                <b><?php echo $this->lang->line('admi_no'); ?></b> <span
                                                    class="pull-right text-aqua"><?php echo $sibling_value->admi_no; ?></span>
                                            </li>
                                            <?php endif; ?>
                                            <li class="list-group-item">
                                                <b><?php echo $this->lang->line('roll_number'); ?></b> <span
                                                    class="pull-right text-aqua"><?php echo $sibling_value->roll_no; ?></span>
                                            </li>
                                            <li class="list-group-item">
                                                <b><?php echo $this->lang->line('class'); ?></b> <a
            ...
            <div class="col-md-12">
                <div class="nav-tabs-custom theme-shadow">
                    <ul class="nav nav-tabs">
                        ...
                        <!-- Internal Exam Results Tab -->
                        <?php if (!empty($internal_results)) { ?>
                            <li><a href="#internal_results" data-toggle="tab"
                                    aria-expanded="true">Internal Results</a></li>
                        <?php } ?>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="activity">
                            <div class="profile-section">
                                <div class="profile-card-grid">
                                    ...
                                    <div class="profile-card">
                                        <h4 class="profile-card-title"><?php echo $this->lang->line('student_details'); ?></h4>
                                        <ul class="profile-card-list">
                                            <?php if ($sch_setting->admission_date) { ?>
                                                <li>
                                                    <i class="fa fa-calendar"></i>
                                                    <span class="profile-card-label"><?php echo $this->lang->line('admission_date'); ?>:</span>
                                                    <span>
                                                        <?php
                                            ...
                                            <li>
                                                <i class="fa fa-calendar"></i>
                                                <span class="profile-card-label"><?php echo $this->lang->line('date_of_birth'); ?>:</span>
                                                <span>
                                                    <?php
                                            ...
                                            <?php if ($sch_setting->student_note) { ?>
                                                <li>
                                                    ...
                                                    <span class="profile-card-label"><?php echo $this->lang->line('note'); ?>:</span>
                                                    <span><?php echo $student['note']; ?></span>
                                                </li>
                                            <?php } ?>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="profile-card">
                                        <h4 class="profile-card-title">Contact Information</h4>

                                        <ul class="profile-card-list">
                                            <?php if ($sch_setting->mobile_no) { ?>
                                                <li>
                                                    <i class="fa fa-phone"></i>
                                                    <span class="profile-card-label"><?php echo $this->lang->line('mobile_number'); ?>:</span>
                                                    <span><?php echo $student['mobileno']; ?></span>
                                                </li>
                                            <?php } ?>
                                            ...
                                            <?php if ($sch_setting->student_email) { ?>
                                                <li>
                                                    ...
                                                    <span class="profile-card-label"><?php echo $this->lang->line('email'); ?>:</span>
                                    ...
                                    <div class="profile-card">
                                        <h4 class="profile-card-title">Personal Category Details</h4>
                                        <ul class="profile-card-list">
                                            <?php if ($sch_setting->category) { ?>
                                                <li>
                                                    <i class="fa fa-tags"></i>
                                                    <span class="profile-card-label"><?php echo $this->lang->line('category'); ?>:</span>
                                                    <span>
                                                        <?php
                                            ...
                                            <?php if ($sch_setting->cast) { ?>
                                                <li>
                                                    ...
                                                    <span class="profile-card-label"><?php echo $this->lang->line('caste'); ?>:</span>
                                                    <span><?php echo $student['cast']; ?></span>
                                                </li>
                                            <?php } ?>
                                            ...
                                            <?php if ($sch_setting->religion) { ?>
                                                <li>
                                                    ...
                                                    <span class="profile-card-label"><?php echo $this->lang->line('religion'); ?>:</span>
                                                    <span><?php echo $student['religion']; ?></span>
                                                </li>
                                            <?php } ?>

                                            <?php
                                            // Custom fields: show Cast Income here and skip Aadhaar numbers (they go to a separate card)
                                            ...
                                            if (!empty($cutom_fields_data)) {
                                                foreach ($cutom_fields_data as $field_key => $field_value) {
                                                    $field_name = trim($field_value->name);

                                                    // Skip Aadhaar fields here, they will be shown in a dedicated card
                                                    if ($field_name == 'Mother Aadhaar Card Number' || $field_name == 'Father Aadhaar Card Number') {
                                                        continue;
                                                    }
                                                    ...
                                                    <li>
                                                        ...
                                                        <span class="profile-card-label"><?php echo $field_value->name; ?>:</span>
                                                        <span>
                                                            <?php
                                    ...
                                    <div class="profile-card">
                                        <h4 class="profile-card-title">Aadhaar Details</h4>
                                        <ul class="profile-card-list">
                                            <?php if ($sch_setting->national_identification_no) { ?>
                                                <li>
                                                    <i class="fa fa-id-card"></i>
                                                    <span class="profile-card-label">Student Aadhaar Card Number:</span>
                                                    <span><?php echo $student['adhar_no']; ?></span>
                                                </li>
                                            <?php } ?>

                                            <?php
                                            // Father Aadhaar Card Number (custom field)
                                            if (!empty($cutom_fields_data)) {
                                                foreach ($cutom_fields_data as $field_key => $field_value) {
                                                    $field_name = trim($field_value->name);
                                                    if ($field_name == 'Father Aadhaar Card Number') {
                                                        ?>
                                                        <li>
                                                            <i class="fa fa-id-card"></i>
                                                            <span class="profile-card-label">Father Aadhaar Card Number:</span>
                                                            <span><?php echo $field_value->field_value; ?></span>
                                                        </li>
                                                        <?php
                                                    }
                                                }
                                            ...
                                            <?php
                                            // Mother Aadhaar Card Number (custom field)
                                            if (!empty($cutom_fields_data)) {
                                                foreach ($cutom_fields_data as $field_key => $field_value) {
                                                    $field_name = trim($field_value->name);
                                                    if ($field_name == 'Mother Aadhaar Card Number') {
                                                        ?>
                                                        <li>
                                                            <i class="fa fa-id-card"></i>
                                                            <span class="profile-card-label">Mother Aadhaar Card Number:</span>
                                                            <span><?php echo $field_value->field_value; ?></span>
                                                        </li>
                                                        <?php
                                                    }
                                            ...
                                            <?php if ($sch_setting->local_identification_no) { ?>
                                                <li>
                                                    ...
                                                    <span class="profile-card-label">Ration Card Number:</span>
                                                    <span><?php echo $student['samagra_id']; ?></span>
                                                </li>
                                            <?php } ?>
                                        </ul>
                                    </div>
                            ...
                            <div class="profile-section">
                                <div class="profile-card profile-card-full">
                                    <h4 class="profile-card-title"><?php echo $this->lang->line('address_details'); ?></h4>
                                    <div class="profile-two-column">
                                        <?php if ($sch_setting->current_address) { ?>
                                            <div class="profile-two-column-item">
                                                <i class="fa fa-map-marker"></i>
                                                <span class="profile-card-label"><?php echo $this->lang->line('current_address'); ?>:</span>
                                                <span><?php echo $student['current_address']; ?></span>
                                            </div>
                                        <?php }
                                        if ($sch_setting->permanent_address) { ?>
                                            <div class="profile-two-column-item">
                                                <i class="fa fa-home"></i>
                                                <span class="profile-card-label"><?php echo $this->lang->line('permanent_address'); ?>:</span>
                                                <span><?php echo $student['permanent_address']; ?></span>
                                            </div>
                                        <?php } ?>
                                    </div>
                                </div>
                            ...
                            <!-- Parent / Guardian Details - 3 modern cards (Father, Mother, Guardian) -->
                            <div class="profile-section">
                                <?php if (($sch_setting->father_name) || ($sch_setting->father_phone) || ($sch_setting->father_occupation) || ($sch_setting->mother_name) || ($sch_setting->mother_phone) || ($sch_setting->mother_occupation) || ($sch_setting->guardian_name) || ($sch_setting->guardian_occupation) || ($sch_setting->guardian_relation) || ($sch_setting->guardian_phone) || ($sch_setting->guardian_email) || ($sch_setting->guardian_address)) { ?>
                                    <div class="profile-card profile-card-full">
                                        <h4 class="profile-card-title"><?php echo $this->lang->line('parent_guardian_detail'); ?></h4>
                                        <div class="profile-card-grid">
                                            ...
                                            <?php if ($sch_setting->father_name || $sch_setting->father_phone || $sch_setting->father_occupation) { ?>
                                                <div class="profile-card">
                                                    <h4 class="profile-card-title">
                                                        ...
                                                        <?php
                                                        $father_img_url = !empty($student['father_pic'])
                                                            ? $this->media_storage->getImageURL($student['father_pic'])
                                                            : $this->media_storage->getImageURL("uploads/student_images/no_image.png");
                                                        ?>
                                                        <a href="#" class="parent-view-image-link" data-img-url="<?php echo $father_img_url; ?>">View Image</a>
                                                    </h4>
                                                    ...
                                                    <ul class="profile-card-list">
                                                        <?php if ($sch_setting->father_name) { ?>
                                                            <li>
                                                                ...
                                                                <span class="profile-card-label"><?php echo $this->lang->line('name'); ?>:</span>
                                                                <span><?php echo str_replace(' ', '&nbsp;', $student['father_name']); ?></span>
                                                            </li>
                                                        <?php } ?>
                                                        ...
                                                        <?php if ($sch_setting->father_phone) { ?>
                                                            <li>
                                                                <i class="fa fa-phone"></i>
                                                                <span class="profile-card-label"><?php echo $this->lang->line('phone'); ?>:</span>
                                                        ...
                                                        <?php if ($sch_setting->father_occupation) { ?>
                                                            <li>
                                                                ...
                                                                <span class="profile-card-label"><?php echo $this->lang->line('occupation'); ?>:</span>
                                                                <span><?php echo $student['father_occupation']; ?></span>
                                                            </li>
                                                        <?php } ?>
                                                    </ul>
                                                </div>
                                            ...
                                            <?php if ($sch_setting->mother_name || $sch_setting->mother_phone || $sch_setting->mother_occupation) { ?>
                                                <div class="profile-card">
                                                    <h4 class="profile-card-title">
                                                        ...
                                                        <?php
                                                        $mother_img_url = !empty($student['mother_pic'])
                                                            ? $this->media_storage->getImageURL($student['mother_pic'])
                                                            : $this->media_storage->getImageURL("uploads/student_images/no_image.png");
                                                        ?>
                                                        <a href="#" class="parent-view-image-link" data-img-url="<?php echo $mother_img_url; ?>">View Image</a>
                                                    </h4>
                                                    ...
                                                    <ul class="profile-card-list">
                                                        <?php if ($sch_setting->mother_name) { ?>
                                                            <li>
                                                                <i class="fa fa-user"></i>
                                                                <span class="profile-card-label"><?php echo $this->lang->line('name'); ?>:</span>
                                                                <span><?php echo str_replace(' ', '&nbsp;', $student['mother_name']); ?></span>
                                                            </li>
                                                        <?php } ?>
                                                        ...
                                                        <?php if ($sch_setting->mother_phone) { ?>
                                                            <li>
                                                                <i class="fa fa-phone"></i>
                                                                <span class="profile-card-label"><?php echo $this->lang->line('phone'); ?>:</span>
                                                                <span><?php echo $student['mother_phone']; ?></span>
                                                            </li>
                                                        <?php } ?>
                                                        ...
                                                        <?php if ($sch_setting->mother_occupation) { ?>
                                                            <li>
                                                                <i class="fa fa-briefcase"></i>
                                                                <span class="profile-card-label"><?php echo $this->lang->line('occupation'); ?>:</span>
                                                                <span><?php echo $student['mother_occupation']; ?></span>
                                                            </li>
                                                        <?php } ?>
                                                    </ul>
                                                </div>
                                            ...
                                            <?php if ($sch_setting->guardian_name || $sch_setting->guardian_phone || $sch_setting->guardian_relation || $sch_setting->guardian_email || $sch_setting->guardian_occupation || $sch_setting->guardian_address) { ?>
                                                <div class="profile-card">
                                                    <h4 class="profile-card-title">
                                                        <i class="fa fa-user"></i>
                                                        Guardian
                                                        ...
                                                        <?php
                                                        $guardian_img_url = !empty($student['guardian_pic'])
                                                            ? $this->media_storage->getImageURL($student['guardian_pic'])
                                                            : $this->media_storage->getImageURL("uploads/student_images/no_image.png");
                                                        ?>
                                                        <a href="#" class="parent-view-image-link" data-img-url="<?php echo $guardian_img_url; ?>">View Image</a>
                                                    </h4>
                                                    ...
                                                    <ul class="profile-card-list">
                                                        <?php if ($sch_setting->guardian_name) { ?>
                                                            <li>
                                                                ...
                                                                <span class="profile-card-label"><?php echo $this->lang->line('name'); ?>:</span>
                                                                <span><?php echo str_replace(' ', '&nbsp;', $student['guardian_name']); ?></span>
                                                            </li>
                                                        <?php } ?>
                                                        ...
                                                        <?php if ($sch_setting->guardian_relation) { ?>
                                                            <li>
                                                                <i class="fa fa-users"></i>
                                                                <span class="profile-card-label"><?php echo $this->lang->line('guardian_relation'); ?>:</span>
                                                                <span><?php echo $student['guardian_relation']; ?></span>
                                                            </li>
                                                        <?php } ?>
                                                        ...
                                                        <?php if ($sch_setting->guardian_phone) { ?>
                                                            <li>
                                                                <i class="fa fa-phone"></i>
                                                                <span class="profile-card-label"><?php echo $this->lang->line('guardian_phone'); ?>:</span>
                                                                <span><?php echo $student['guardian_phone']; ?></span>
                                                            </li>
                                                        <?php } ?>
                                                        ...
                                                        <?php if ($sch_setting->guardian_email) { ?>
                                                            <li>
                                                                <i class="fa fa-envelope"></i>
                                                                <span class="profile-card-label"><?php echo $this->lang->line('guardian_email'); ?>:</span>
                                                                <span><?php echo $student['guardian_email']; ?></span>
                                                            </li>
                                                        <?php } ?>
                                                        ...
                                                        <?php if ($sch_setting->guardian_occupation) { ?>
                                                            <li>
                                                                <i class="fa fa-briefcase"></i>
                                                                <span class="profile-card-label"><?php echo $this->lang->line('guardian_occupation'); ?>:</span>
                                                                <span><?php echo $student['guardian_occupation']; ?></span>
                                                            </li>
                                                        <?php } ?>
                                                        ...
                                                        <?php if ($sch_setting->guardian_address) { ?>
                                                            <li>
                                                                <i class="fa fa-map-marker"></i>
                                                                <span class="profile-card-label"><?php echo $this->lang->line('guardian_address'); ?>:</span>
                                                                <span><?php echo $student['guardian_address']; ?></span>
                                                            </li>
                                                        <?php } ?>
                                                    </ul>
                                                </div>
                            ...
                            <div class="modal fade" id="parentImageModal" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-body text-center">
                                            <img id="parentImageModalImg" src="" class="img-responsive" style="margin:0 auto; max-width:100%; height:auto;" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="profile-section">
                                <div class="profile-card-grid">
                                    ...
                                    <?php if ($sch_setting->bank_account_no || $sch_setting->ifsc_code) { ?>
                                        <div class="profile-card">
                                            <h4 class="profile-card-title">Bank Details</h4>

                                            <ul class="profile-card-list">
                                                <?php if ($sch_setting->bank_account_no) { ?>
                                                    <li>
                                                        <i class="fa fa-credit-card"></i>
                                                        <span class="profile-card-label"><?php echo $this->lang->line('bank_account_number'); ?>:</span>
                                                        <span><?php echo $student['bank_account_no']; ?></span>
                                                    </li>
                                                <?php } ?>
                                                ...
                                                <?php if ($sch_setting->ifsc_code) { ?>
                                                    <li>
                                                        <i class="fa fa-university"></i>
                                                        <span class="profile-card-label"><?php echo $this->lang->line('bank_name'); ?>:</span>
                                                        <span><?php echo $student['bank_name']; ?></span>
                                                    </li>

                                                    <li>
                                                        <i class="fa fa-hashtag"></i>
                                                        <span class="profile-card-label"><?php echo $this->lang->line('ifsc_code'); ?>:</span>
                                                        <span><?php echo $student['ifsc_code']; ?></span>
                                                    </li>
                                                <?php } ?>
                                            </ul>
                                        </div>
                                    ...
                                    <?php if ($sch_setting->is_blood_group || $sch_setting->is_student_house || $sch_setting->student_height || $sch_setting->student_weight || $sch_setting->measurement_date || $sch_setting->previous_school_details) { ?>
                                        <div class="profile-card">
                                            <h4 class="profile-card-title">Student Health Metrics</h4>

                                            <ul class="profile-card-list">
                                                <?php if ($sch_setting->is_blood_group) { ?>
                                                    <li>
                                                        <i class="fa fa-tint"></i>
                                                        <span class="profile-card-label"><?php echo $this->lang->line('blood_group'); ?>:</span>
                                                ...
                                                <?php if ($sch_setting->is_student_house) { ?>
                                                    <li>
                                                        <i class="fa fa-home"></i>
                                                        <span class="profile-card-label"><?php echo $this->lang->line('house'); ?>:</span>
                                                        <span><?php echo $student['house_name']; ?></span>
                                                    </li>
                                                <?php } ?>
                                                ...
                                                <?php if ($sch_setting->student_height) { ?>
                                                    <li>
                                                        ...
                                                        <span class="profile-card-label"><?php echo $this->lang->line('height'); ?>:</span>
                                                        <span><?php echo $student['height']; ?></span>
                                                    </li>
                                                <?php } ?>
                                                ...
                                                <?php if ($sch_setting->student_weight) { ?>
                                                    <li>
                                                        ...
                                                        <span class="profile-card-label"><?php echo $this->lang->line('weight'); ?>:</span>
                                                        <span><?php echo $student['weight']; ?></span>
                                                    </li>
                                                <?php } ?>
                                                ...
                                                <?php if ($sch_setting->measurement_date) { ?>
                                                    <li>
                                                        <i class="fa fa-calendar"></i>
                                                        <span class="profile-card-label"><?php echo $this->lang->line('measurement_date'); ?>:</span>
                                                        <span>
                                                            <?php
                                                ...
                                                <?php if ($sch_setting->previous_school_details) { ?>
                                                    <li>
                                                        ...
                                                        <span class="profile-card-label"><?php echo $this->lang->line('previous_school_details'); ?>:</span>
                                                        <span><?php echo $student['previous_school']; ?></span>
                                                    </li>
                                                <?php } ?>
                                            </ul>
                                        </div>
                        ...
                        <div class="tab-pane" id="fee">
                            <style>
                                /* Fee status row colors - high specificity to override table-striped */
                                table.table-striped tbody tr.fee-status-paid td { background-color: #d4edda !important; }
                                table.table-striped tbody tr.fee-status-partial td { background-color: #fff3cd !important; }
                                table.table-striped tbody tr.fee-status-partial-overdue td { background-color: #ffe0b2 !important; }
                                table.table-striped tbody tr.fee-status-unpaid td { background-color: #fce4ec !important; }
                                table.table-striped tbody tr.danger.font12 td { background-color: #f2dede !important; }
                                /* Also target without table-striped prefix for transport/hostel tables */
                                table.table-hover tbody tr.fee-status-paid td { background-color: #d4edda !important; }
                                table.table-hover tbody tr.fee-status-partial td { background-color: #fff3cd !important; }
                                table.table-hover tbody tr.fee-status-partial-overdue td { background-color: #ffe0b2 !important; }
                                table.table-hover tbody tr.fee-status-unpaid td { background-color: #fce4ec !important; }
                                table.table-hover tbody tr.danger.font12 td { background-color: #f2dede !important; }
                                /* Catch-all for any table */
                                table tbody tr.fee-status-paid td { background-color: #d4edda !important; }
                                table tbody tr.fee-status-partial td { background-color: #fff3cd !important; }
                                table tbody tr.fee-status-partial-overdue td { background-color: #ffe0b2 !important; }
                                table tbody tr.fee-status-unpaid td { background-color: #fce4ec !important; }
                                table tbody tr.danger.font12 td { background-color: #f2dede !important; }
                            </style>
                            <?php
                                        ...
                                        <tbody>
                                            ...
                                            if(isset($fees_by_session) && !empty($fees_by_session)) {
                                                foreach($sessions as $session_id => $session_name) {
                                                    ...
                                                    if ($feetype_balance == 0) {
                                                        ?>
                                                        <tr class="fee-status-paid font12" style="background-color: #d4edda !important;">
                                                            <?php
                                                    } else if (!empty($fee_value->amount_detail)) {
                                                        if (($fee_value->due_date != "0000-00-00" && $fee_value->due_date != null) && strtotime($fee_value->due_date) < strtotime(date('Y-m-d'))) {
                                                            ?>
                                                            <tr class="fee-status-partial-overdue font12" style="background-color: #ffe0b2 !important;">
                                                            <?php
                                                        } else {
                                                            ?>
                                                            <tr class="fee-status-partial font12" style="background-color: #fff3cd !important;">
                                                            <?php
                                                        }
                                                    } else if ($feetype_balance > 0 && ($fee_value->due_date != "0000-00-00" && $fee_value->due_date != null) && strtotime($fee_value->due_date) < strtotime(date('Y-m-d'))) {
                                                        ?>
                                                        <tr class="danger font12" style="background-color: #f2dede !important;">
                                                            <?php
                                                    } else {
                                                        ?>
                                                        <tr class="fee-status-unpaid font12" style="background-color: #fce4ec !important;">
                                                            <?php
                                                    }
                                                    ?>
                                                        <td>
                                            ...
                                            if (!empty($transport_fees)) {
                                                foreach ($transport_fees as $transport_fee_key => $transport_fee_value) {
                                                    ...
                                                    } else if (($transport_fee_value->due_date != "0000-00-00" && $transport_fee_value->due_date != null) && strtotime($transport_fee_value->due_date) < strtotime(date('Y-m-d'))) {
                                                        ?>
                                                        <tr class="danger font12" style="background-color: #f2dede !important;">
                                                            <?php
                                                    } else {
                                            ...
                                            if(isset($additional_fees_by_session) && !empty($additional_fees_by_session)) {
                                                foreach($sessions as $session_id => $session_name) {
                                                    if(isset($additional_fees_by_session[$session_id]) && !empty($additional_fees_by_session[$session_id])) {
                                                        // Display session header if not already displayed for this session
                                                        if(!isset($displayed_sessions[$session_id])) {
                                                            ?>
                                                            ...
                                                            <?php
                                                            $displayed_sessions[$session_id] = true;
                                                        }
                                                        ...
                                                        <?php
                                                        // Display additional fees for this session
                        ...
                        <!-- Internal Results Tab Content -->
                        <?php if (!empty($internal_results)) { ?>
                            <div class="tab-pane" id="internal_results">
                                <div id="internal_results_visible">
                                    <center>
                                        <h4 class="hide" id="internal_results_student_name">
                                    ...
                                    <div class="dt-buttons btn-group pull-right miusDM42">
                                        <a class="btn btn-default btn-xs dt-button no_print border0" id="print_internal_results"
                                            data-toggle="tooltip" data-placement="bottom" title="Print"
                                            onclick="printInternalResults()"><i class="fa fa-print"></i></a>
                                    </div>

                                    <style>
                                        /* Enhanced styling for Internal Results */
                                        .internal-results-table {
                                            margin-bottom: 20px;
                                        }
                                        .internal-results-table thead th {
                                        ...
                                        .internal-results-table tbody td {
                                            vertical-align: middle;
                                            text-align: center;
                                        }
                                        .internal-results-table tbody td:first-child {
                                            text-align: left;
                                            font-weight: 500;
                                        }
                                        .internal-results-table tbody td:nth-child(3),
                                        .internal-results-table tbody td:nth-child(4),
                                        .internal-results-table tbody td:nth-child(5) {
                                            text-align: right;
                                            font-family: 'Courier New', monospace;
                                        }
                                        .internal-results-totals-row {
                                            background-color: #e8f4f8 !important;
                                            border-top: 3px solid #3c8dbc !important;
                                        }
                                        .internal-results-totals-row td {
                                            font-size: 15px;
                                            font-weight: bold !important;
                                            padding: 12px 8px !important;
                                        }
                                        .internal-results-summary-row {
                                            background-color: #d9edf7 !important;
                                            border-top: 2px solid #3c8dbc !important;
                                        }
                                        .internal-results-summary-row td {
                                    ...
                                    <?php foreach ($internal_results as $session_data) { ?>
                                        <div class="tshadow mb25">
                                            <h4 class="pagetitleh">
                                                <i class="fa fa-graduation-cap"></i> Academic Session: <?php echo $session_data['session_name']; ?>
                                            </h4>

                                            <?php foreach ($session_data['exams'] as $exam_data) { ?>
                                                <div class="table-responsive">
                                                    <div class="exam-header-section">
                                                        <h5><i class="fa fa-file-text-o"></i> <?php echo $exam_data['exam_name']; ?></h5>
                                                    </div>

                                                    <table class="table table-striped table-bordered internal-results-table">
                                                        <thead>
                                                            <tr>
                                                        ...
                                                        <tbody>
                                                            <?php foreach ($exam_data['subjects'] as $subject) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo $subject['minmarks']; ?></td>
                                                                    <td><?php echo $subject['maxmarks']; ?></td>
                                                                    <td class="marks-obtained-cell"><?php echo $subject['actualmarks']; ?></td>
                                                                    <td>
                                                                        <?php if (isset($subject['is_absent']) && $subject['is_absent']) { ?>
                                                                            <span class="result-badge-fail">
                                                                                <i class="fa fa-ban"></i> Absent
                                                                            </span>
                                                                        <?php } elseif ($subject['pass']) { ?>
                                                                            <span class="result-badge-pass">
                                                                                <i class="fa fa-check-circle"></i> <?php echo $this->lang->line('pass'); ?>
                                                                            </span>
                                                                        <?php } else { ?>
                                                                            <span class="result-badge-fail">
                                                                                <i class="fa fa-times-circle"></i> <?php echo $this->lang->line('fail'); ?>
                                                                            </span>
                                                                        <?php } ?>
                                                                    </td>
                                                                </tr>
                                                        ...
                                                        <tfoot>
                                                            <tr class="internal-results-totals-row">
                                                                <td colspan="2" class="text-right">
                                                                    <i class="fa fa-calculator"></i> <?php echo $this->lang->line('grand_total'); ?>:
                                                                </td>
                                                                <td style="text-align: right;"><?php echo $exam_data['total_min_marks']; ?></td>
                                                                <td style="text-align: right;"><?php echo $exam_data['total_max_marks']; ?></td>
                                                                <td style="text-align: right; font-size: 18px; color: #3c8dbc;">
                                                                    <?php echo $exam_data['total_marks']; ?>
                                                                </td>
                                                                <td style="text-align: center;">
                                                                    <?php if ($exam_data['pass_status'] === 'absent') { ?>
                                                                        <span class="result-badge-fail" style="font-size: 14px; padding: 6px 15px;">
                                                                            <i class="fa fa-ban"></i> Absent
                                                                        </span>
                                                                    <?php } elseif ($exam_data['pass_status']) { ?>
                                                                        <span class="result-badge-pass" style="font-size: 14px; padding: 6px 15px;">
                                                                            <i class="fa fa-check-circle"></i> <?php echo $this->lang->line('pass'); ?>
                                                                        </span>
                                                                    <?php } else { ?>
                                                                        <span class="result-badge-fail" style="font-size: 14px; padding: 6px 15px;">
                                                    ...
                                                    <div class="summary-info-box">
                                                        <div class="summary-info-item">
                                                            <span class="summary-info-label">Total Marks:</span>
                                                            <span class="summary-info-value"><?php echo $exam_data['total_marks']; ?> / <?php echo $exam_data['total_max_marks']; ?></span>
                                                        </div>
                                                        <div class="summary-info-item">
                                                            <span class="summary-info-label">Minimum Required:</span>
                                                            <span class="summary-info-value"><?php echo $exam_data['total_min_marks']; ?></span>
                                                        </div>
                                                        <div class="summary-info-item">
                                                            <span class="summary-info-label">Percentage:</span>
                                                            <span class="percentage-badge">
                                                                <i class="fa fa-percent"></i> <?php echo $exam_data['percentage']; ?>%
                                                            </span>
                                                        </div>
                                                        <div class="summary-info-item">
                                                            <span class="summary-info-label">Overall Status:</span>
                                                            <?php if ($exam_data['pass_status'] === 'absent') { ?>
                                                                <span class="result-badge-fail" style="font-size: 14px;">
                                                                    <i class="fa fa-ban"></i> ABSENT
                                                                </span>
                                                            <?php } elseif ($exam_data['pass_status']) { ?>
                                                                <span class="result-badge-pass" style="font-size: 14px;">
                                                                    <i class="fa fa-trophy"></i> PASSED
                                                                </span>
                                                            <?php } else { ?>
                                                                <span class="result-badge-fail" style="font-size: 14px;">
...
<script type="text/javascript">
    ...
    function printInternalResults() {
        $("#internal_results_visible").removeClass("hide");
        $("#internal_results_student_name").removeClass("hide");

        document.getElementById("print_internal_results").style.display = "none";
        var divElements = document.getElementById('internal_results_visible').innerHTML;
        var oldPage = document.body.innerHTML;
        document.body.innerHTML =
            "<html><head><title></title></head><body>" +
            divElements + "</body>";
...
$(document).ready(function() {
    ...
    $('.parent-view-image-link').on('click', function (e) {
        e.preventDefault();
        var imgUrl = $(this).data('img-url') || $(this).data('imgUrl');
        if (!imgUrl) {
            return;
        }
        $('#parentImageModalImg').attr('src', imgUrl);
        $('#parentImageModal').modal('show');
    });
});
</script>