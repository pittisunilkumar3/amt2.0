                ...
                ?>>
                    <div class="box box-widget widget-user-2 mb0">
                        <div class="widget-user-header bg-gray-light overflow-hidden">
                            ...
                            <h5 class="widget-user-desc mb5"><?php echo $this->lang->line('admi_no'); ?> <span
                                    class="text-aqua"><?php echo $student['admi_no']; ?></span></h5>
                            <?php endif; ?>
                        ...
                        foreach ($siblings as $sibling_key => $sibling_value) {
                            ...
                            <div class="box-widget widget-user-2">
                                ...
                                <div class="widget-user-header bg-gray-light overflow-hidden">
                                    ...
                                    <h5 class="widget-user-desc mb5"><?php echo $this->lang->line('admi_no'); ?> <span
                                            class="text-aqua"><?php echo $sibling_value->admi_no; ?></span></h5>
                                    <?php endif; ?>
                                    <h5 class="widget-user-desc"><?php echo $this->lang->line('roll_number'); ?> <span
