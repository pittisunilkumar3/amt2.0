                    ...
                    <div class="bozero">
                        ...
                        <div class="box-body">
                            <?php if ($this->session->flashdata('msg')) { ?> 
                                <div>  <?php echo $this->session->flashdata('msg'); $this->session->unset_userdata('msg'); ?> </div> 
                            <?php }?>
                            
                            <p class="text-muted">1. <?php echo $this->lang->line('import_student_step1'); ?></p>
                            <p class="text-muted">2. <?php echo $this->lang->line('import_student_step2'); ?></p>
                            <p class="text-muted">3. <?php echo $this->lang->line('import_student_step3'); ?></p>
                            <p class="text-muted">4. <?php echo $this->lang->line('import_student_step4'); ?></p>
                            <p class="text-muted">5. <?php echo $this->lang->line('import_student_step5'); ?></p>
                            <p class="text-muted">6. <?php echo $this->lang->line('import_student_step6'); ?></p>
                            <p class="text-muted">7. <?php echo $this->lang->line('import_student_step7'); ?></p>
                            <p class="text-muted">8. <?php echo $this->lang->line('import_student_step8'); ?></p>
                            <p class="text-muted">9. <?php echo $this->lang->line('import_student_step9'); ?></p>
                            <hr/>
                        </div>

                        <!-- Table Wrapper for Scroll -->
                        <div class="box-body" style="overflow-x: auto; display: block; white-space: nowrap;">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        foreach ($fields as $key => $value) {
                                            ...
                                            if ($value == 'guardian_is') { $value = "if_guardian_is"; }
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select autofocus="" id="class_id" name="class_id" class="form-control multiselect-dropdown" >
