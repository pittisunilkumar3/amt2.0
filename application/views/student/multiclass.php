                                        ...
                                        ?>
                                            <div class="col-md-6">
                                                <form action="<?php echo site_url('student/savemulticlass'); ?>" method="POST" class="update">
                                                    <div class="panel panel-info multiclass-item">
                                                        <div class="panel-body panelheight">
                                                            ...
                                                            <div class="multiclass-header">
                                                                ...
                                                                <?php if ($this->rbac->hasPrivilege('multi_class_student', 'can_add')) { ?>
                                                                    <button type="button" class="btn btn-default btn-sm addrow addrow-mb2010" data-toggle="tooltip" title="<?php echo $this->lang->line('add_class'); ?>">
