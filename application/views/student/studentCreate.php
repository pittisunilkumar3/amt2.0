                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <input id="admi_no" name="admi_no" placeholder="" type="text" class="form-control"  value="<?php echo $admi_no; ?>" />
...
?>
                            ...
                            <div class="bozero">
                                ...
                                <div class="row around10">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <label ><?php echo $this->lang->line('application_document'); ?></label><small class="req"> *</small>
                                                <input class="filestyle form-control" type='file' name='apply_doc' id="apply_doc" >
