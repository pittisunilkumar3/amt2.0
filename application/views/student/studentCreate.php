...
<div class="content-wrapper">
    <!-- Main content -->
    <section class="content student-admission-wrapper">
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id="form1" action="<?php echo site_url('student/create') ?>" id="employeeform" name="employeeform" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                            ...
                            <div class="bozero">
                                ...
                                <div class="around10">
                                    ...
                                    <div class="row">
                                        <?php if (!$adm_auto_insert) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input autofocus="" id="admission_no" name="admission_no" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('admission_no'); ?>" />
                                            ...
                                            <?php if (!$sroll_auto_insert) { ?>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="roll_no" name="roll_no" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('roll_no'); ?>" />
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                <label for="exampleInputEmail1"><?php echo $this->lang->line('admi_no'); ?></label>
                                                <input id="admi_no" name="admi_no" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('admi_no'); ?>" />
                                                <span class="text-danger"><?php echo form_error('admi_no'); ?></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select id="class_id" name="class_id" class="form-control multiselect-dropdown">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select id="section_id" name="section_id" class="form-control multiselect-dropdown">
                                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                </select>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input id="firstname" name="firstname" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('firstname'); ?>" />
                                        ...
                                        <?php if ($sch_setting->middlename) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="middlename" name="middlename" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('middlename'); ?>" />
                                        ...
                                        <?php if ($sch_setting->lastname) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="lastname" name="lastname" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('lastname'); ?>" />
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control multiselect-dropdown" name="gender">
                                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                    <?php
                                        ...
                                        ?>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <select id="category_id" name="category_id" class="form-control multiselect-dropdown">
                                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                                        ...
                                        if ($sch_setting->religion) { ?>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input id="religion" name="religion" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('religion'); ?>" />
                                        ...
                                        if ($sch_setting->cast) { ?>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <input id="cast" name="cast" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('cast'); ?>" />
                                        ...
                                        if ($sch_setting->mobile_no) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="mobileno" name="mobileno" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('mobileno'); ?>" />
                                        ...
                                        if ($sch_setting->student_email) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="email" name="email" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('email'); ?>" />
                                        ...
                                        if ($sch_setting->student_photo) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div><input class="filestyle form-control" type='file' name='file' id="file" size='20' accept="image/*" onchange="previewImage(this, 'student_photo_preview')"/>
                                                    <img id="student_photo_preview" src="#" alt="Preview" style="display:none; max-width:80px; max-height:80px; margin-top:5px; border:1px solid #ddd; border-radius:4px;">
                                                    </div>
                                        ...
                                        ?>
                                            <div class="col-md-3 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <?php
                                                    ?>
                                                    <select class="form-control multiselect-dropdown" rows="3" placeholder="" name="blood_group">
                                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                                        ...
                                        ?>
                                            <div class="col-md-3 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control multiselect-dropdown" rows="3" placeholder="" name="house">
                                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                                    ...
                                    <div class="row">
                                        <?php if ($sch_setting->student_height) { ?>
                                            <div class="col-md-3 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <?php ?>
                                                    <input type="text" name="height" class="form-control multiselect-dropdown" value="<?php echo set_value('height'); ?>">
                                        ...
                                        if ($sch_setting->student_weight) { ?>
                                            <div class="col-md-3 col-xs-12">
                                                <div class="form-group">
                                                    ...
                                                    <?php ?>
                                                    <input type="text" name="weight" class="form-control multiselect-dropdown" value="<?php echo set_value('weight'); ?>">
                                        ...
                                        <div class="col-md-3" style="display:none;">
                                            <div class="form-group">
                                                ...
                                                <input id="fees_discount" name="fees_discount" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('fees_discount', 0); ?>" />
                        ...
                        <div class="bozero">
                            <h4 class="pagetitleh2"><?php echo $this->lang->line('reference_upload_doc'); ?></h4>
                            ...
                            <div class="row around10">
                                ...
                                <div class="col-md-7">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('application_document'); ?></label>
                                        <input class="filestyle form-control" type='file' name='apply_doc' id="apply_doc" accept=".pdf,application/pdf">
                                        <p class="text-muted" style="font-size:11px; margin:4px 0 0;"><i class="fa fa-info-circle"></i> Only PDF files are accepted</p>
                                        <span class="text-danger"><?php echo form_error('apply_doc'); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="row around10">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control multiselect-dropdown" id="vehroute_id" name="vehroute_id">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control multiselect-dropdown" id="pickup_point" name="route_pickup_point_id">
                                        ...
                                        <div class="row around10">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control multiselect-dropdown" id="hostel_id" name="hostel_id">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select id="hostel_room_id" name="hostel_room_id" class="form-control multiselect-dropdown">
                                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                                                    </select>
                                        ...
                                        <?php if ($sch_setting->father_name) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="father_name" name="father_name" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('father_name'); ?>" />
                                        ...
                                        if ($sch_setting->father_phone) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="father_phone" name="father_phone" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('father_phone'); ?>" />
                                        ...
                                        if ($sch_setting->father_occupation) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="father_occupation" name="father_occupation" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('father_occupation'); ?>" />
                                        ...
                                        if ($sch_setting->father_pic) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div><input class="filestyle form-control" type='file' name='father_pic' id="father_pic" size='20' accept="image/*" onchange="previewImage(this, 'father_photo_preview')"/>
                                                    <img id="father_photo_preview" src="#" alt="Preview" style="display:none; max-width:80px; max-height:80px; margin-top:5px; border:1px solid #ddd; border-radius:4px;">
                                                    </div>
                                        ...
                                        <?php if ($sch_setting->mother_name) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="mother_name" name="mother_name" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('mother_name'); ?>" />
                                        ...
                                        if ($sch_setting->mother_phone) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="mother_phone" name="mother_phone" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('mother_phone'); ?>" />
                                        ...
                                        if ($sch_setting->mother_occupation) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="mother_occupation" name="mother_occupation" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('mother_occupation'); ?>" />
                                        ...
                                        if ($sch_setting->mother_pic) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div><input class="filestyle form-control" type='file' name='mother_pic' id="mother_pic" size='20' accept="image/*" onchange="previewImage(this, 'mother_photo_preview')"/>
                                                    <img id="mother_photo_preview" src="#" alt="Preview" style="display:none; max-width:80px; max-height:80px; margin-top:5px; border:1px solid #ddd; border-radius:4px;">
                                                    </div>
                                    ...
                                    <div class="row">
                                                ...
                                                ?>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="guardian_name" name="guardian_name" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('guardian_name'); ?>" />
                                                ...
                                                if ($sch_setting->guardian_relation) { ?>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="guardian_relation" name="guardian_relation" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('guardian_relation'); ?>" />
                                                ...
                                                ?>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="guardian_phone" name="guardian_phone" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('guardian_phone'); ?>" />
                                                ...
                                                ?>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="guardian_occupation" name="guardian_occupation" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('guardian_occupation'); ?>" />
                                        ...
                                        <?php if ($sch_setting->guardian_email) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input id="guardian_email" name="guardian_email" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('guardian_email'); ?>" />
                                        ...
                                        if ($sch_setting->guardian_pic) { ?>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div><input class="filestyle form-control" type='file' name='guardian_pic' id="guardian_pic" size='20' accept="image/*" onchange="previewImage(this, 'guardian_photo_preview')"/>
                                                    <img id="guardian_photo_preview" src="#" alt="Preview" style="display:none; max-width:80px; max-height:80px; margin-top:5px; border:1px solid #ddd; border-radius:4px;">
                                                    </div>
                                        ...
                                        if ($sch_setting->guardian_address) { ?>
                                            <div class="col-md-6">
                                                ...
                                                <textarea id="guardian_address" name="guardian_address" placeholder="" class="form-control multiselect-dropdown" rows="2"><?php echo set_value('guardian_address'); ?></textarea>
                                            ...
                                            <?php if ($sch_setting->current_address) { ?>
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="current_address" name="current_address" placeholder="" class="form-control multiselect-dropdown"><?php echo set_value('current_address'); ?></textarea>
                                            ...
                                            if ($sch_setting->permanent_address) { ?>
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea id="permanent_address" name="permanent_address" placeholder="" class="form-control multiselect-dropdown"><?php echo set_value('permanent_address'); ?></textarea>
                                            ...
                                            <?php if ($sch_setting->bank_account_no) { ?>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="bank_account_no" name="bank_account_no" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('bank_account_no'); ?>" />
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="bank_name" name="bank_name" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('bank_name'); ?>" />
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="ifsc_code" name="ifsc_code" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('ifsc_code'); ?>" />
                                            ...
                                            <?php if ($sch_setting->national_identification_no) { ?>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="adhar_no" name="adhar_no" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('adhar_no'); ?>" />
                                            ...
                                            if ($sch_setting->local_identification_no) { ?>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="samagra_id" name="samagra_id" placeholder="" type="text" class="form-control multiselect-dropdown" value="<?php echo set_value('samagra_id'); ?>" />
                                            ...
                                            if ($sch_setting->previous_school_details) { ?>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control multiselect-dropdown" rows="3" placeholder="" name="previous_school"></textarea>
                                            ...
                                            if ($sch_setting->student_note) { ?>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control multiselect-dropdown" rows="3" placeholder="" name="note"></textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="tshadow bozero">
                                                        ...
                                                        <p class="text-muted" style="font-size:12px; margin-bottom:10px; padding-left:10px;"><i class="fa fa-info-circle"></i> Upload supporting documents (PDF, JPG, PNG, JPEG). Title is optional but recommended.</p>
                                                        <div class="row around10">
                                                            <div class="col-md-6">
                                                                <table class="table table-bordered table-striped">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>1.</td>
                                                                            <td><input type="text" name='first_title' class="form-control" placeholder="e.g. Birth Certificate"></td>
                                                                            <td>
                                                                                <input class="filestyle form-control" type='file' name='first_doc' id="first_doc" accept=".pdf,.jpg,.jpeg,.png,.doc,.docx">
                                                                                <span class="text-danger"><?php echo form_error('first_doc'); ?></span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>2.</td>
                                                                            <td><input type="text" name='second_title' class="form-control" placeholder="e.g. Transfer Certificate"></td>
                                                                            <td>
                                                                                <input class="filestyle form-control" type='file' name='second_doc' id="second_doc" accept=".pdf,.jpg,.jpeg,.png,.doc,.docx">
                                                            ...
                                                            <div class="col-md-6">
                                                                <table class="table table-bordered table-striped">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>3.</td>
                                                                            <td><input type="text" name='fourth_title' class="form-control" placeholder="e.g. Aadhaar Card"></td>
                                                                            <td>
                                                                                <input class="filestyle form-control" type='file' name='fourth_doc' id="fourth_doc" accept=".pdf,.jpg,.jpeg,.png,.doc,.docx">
                                                                                <span class="text-danger"><?php echo form_error('fourth_doc'); ?></span>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>4.</td>
                                                                            <td><input type="text" name='fifth_title' class="form-control" placeholder="e.g. Caste Certificate"></td>
                                                                            <td>
                                                                                <input class="filestyle form-control" type='file' name='fifth_doc' id="fifth_doc" accept=".pdf,.jpg,.jpeg,.png,.doc,.docx">
            ...
            <div class="modal-body pb0">
                <div class="form-horizontal">
                    <div class="box-body pt0 pb0">
                        <input type="hidden" class="form-control multiselect-dropdown" id="transport_student_session_id" value="0" readonly="readonly" />
                        <div class="form-group">
                            <div class="sibling_msg">
                            </div>
                            <label for="inputEmail3" class="col-sm-2 control-label"><?php echo $this->lang->line('class'); ?></label>
                            <div class="col-sm-10">
                                <select id="sibiling_class_id" name="sibiling_class_id" class="form-control multiselect-dropdown">
                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                    <?php
                                    foreach ($classlist as $class) {
                                    ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select id="sibiling_section_id" name="sibiling_section_id" class="form-control multiselect-dropdown">
                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select id="sibiling_student_id" name="sibiling_student_id" class="form-control multiselect-dropdown">
                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                                </select>
...
<script>
    /* REMOVED: Legacy multiselect library was removed, causing JS errors.
    ...
    $(document).ready(function() {
        $(document).on('change', '.fee_group_chk', function() {
            ...
            $.ajax({
                ...
                dataType: "json",
                beforeSend: function() {
                    // Silent update - no loader needed for simple calc
                },
                success: function(data) {
                    console.log(data);
...
<script type="text/javascript">
    ...
    // Application document file name display and validation
    $(document).ready(function() {
        $('#apply_doc').on('change', function(e) {
            var file = this.files[0];
            if (file) {
                var ext = file.name.split('.').pop().toLowerCase();
                if (ext !== 'pdf') {
                    alert('Only PDF files are allowed for Application Document.');
                    this.value = '';
                    $('#apply_doc_name').val('');
                    $('#apply_doc_preview').hide();
                    return false;
                }
                ...
                $('#apply_doc_name').val(file.name);
                $('#apply_doc_preview_name').text(file.name + ' (' + (file.size / 1024).toFixed(1) + ' KB)');
                $('#apply_doc_preview').show();
            } else {
                $('#apply_doc_name').val('');
                $('#apply_doc_preview').hide();
            }
    ...
    $(document).on('submit', '#form1', function(e) {
        var applyDoc = document.getElementById('apply_doc');
        if (applyDoc && applyDoc.files.length === 0) {
            var hasError = false;
            // Check if there's a server-side validation error message for apply_doc
            if ($('span.text-danger:contains("application")').length > 0 || $('span.text-danger:contains("PDF")').length > 0 || $('span.text-danger:contains("select")').length > 0) {
                hasError = true;
            }
        }
    });
