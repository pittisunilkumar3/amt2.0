                ...
                <div class="box box-info" style="padding:5px;">
                    <div class="box-header with-border">
                        ...
                        <div class="pull-right box-tools">
                            <a href="<?php echo site_url('admin/testt/feeexportformat') ?>">
...
foreach ($fields as $key => $value) {
    ...
    ?>
                    ...
                    <form action="<?php echo site_url('admin/testt/addstudentfee') ?>"  id="employeeform" name="employeeform" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1"><?php echo $this->lang->line('fee_group_id'); ?></label><small class="req"> *</small>
            ...
            <script type="text/javascript">
                function getSectionByClass(class_id, section_id) {
                    if (class_id != "" && section_id != "") {
                        ...
                        $.ajax({
                            type: "GET",
                            url: base_url + "admin/testt/getfeetype",
                            ...
                            success: function (data) {
                                ...
                                {
                                    var sel = "";
                                    if (section_id == obj.typeid) {
                                        sel = "selected";
                                    }
                                    div_data += "<option value=" + obj.typeid + " " + sel + ">" + obj.type + "</option>";
                                });
                    ...
                    $(document).on('change', '#class_id', function (e) {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                $.each(data, function (i, obj)
                                {
                                    div_data += "<option value=" + obj.typeid + ">" + obj.type + "</option>";
                                });
                                $('#section_id').append(div_data);
                            }
                        });
