...
?>
                        ...
                        <?php if (isset($result['salary_type']) && $result['salary_type'] === 'hourly') { ?>
                        <tr>
                            <th width="20%">Salary Type</th>
                            <td class="text-right"><span class="label label-info">Hourly</span></td>
                        </tr>
                        <tr>
                            <th width="20%">Hourly Rate (<?php echo $currency_symbol; ?>)</th>
                            <td class="text-right"><?php echo amountFormat($result['hourly_rate']); ?></td>
                        </tr>
                        <tr>
                            <th width="20%">Total Hours Worked</th>
                            <td class="text-right"><?php echo number_format((float)$result['total_hours_worked'], 2); ?> hrs</td>
                        </tr>
                        <?php } elseif (isset($result['total_hours_worked']) && $result['total_hours_worked'] > 0) { ?>
                        <tr>
                            <th width="20%">Salary Type</th>
                            <td class="text-right"><span class="label label-success">Monthly</span></td>
                        </tr>
                        <tr>
                            <th width="20%">Total Hours Worked</th>
                            <td class="text-right"><?php echo number_format((float)$result['total_hours_worked'], 2); ?> hrs</td>
                        ...
                        <tr>
                            ...
                            <td class="text-right"><small class="text-muted"><?php echo htmlspecialchars($result['remark']); ?></small></td>
                        </tr>
                        <?php } ?>
                        <tr>
                            <td align="center">
