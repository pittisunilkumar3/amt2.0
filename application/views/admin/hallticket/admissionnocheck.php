        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="row">
                            <form role="form" action="<?php echo site_url('admin/hallticket/admino/search') ?>" method="post" class="">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('admi_status'); ?></label><small class="req">*</small>
                                            ...
                                            if (empty($resultlist)) {
                                                ...
                                                foreach ($resultlist as $student) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="admi_no_display" data-student-id="<?php echo $student['id']; ?>">
                                                        ...
                                                        <?php }else {?>
                                                            ...
                                                            <!-- <a href=" . site_url('studentfee/addfee/' . $student->student_session_id) . "  class='btn btn-info btn-xs'>" .  . "</a> -->
                                                                ...
                                                                <a class='btn btn-info btn-xs admi_no_btn' data-toggle="modal" data-target="#myAdmiEditModal" data-student_id="<?php echo $student['id']; ?>" data-student_name="<?php echo $this->customlib->getFullName($student['firstname'],$student['middlename'],$student['lastname'],$sch_setting->middlename,$sch_setting->lastname); ?>"><?php echo $this->lang->line('add_admi_no');?></i></a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body pb0">
                <div class="form-horizontal balanceformpopup">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label for="inputEmail3" class="col-sm-3 control-label"><?php echo $this->lang->line('admi_no'); ?><small class="req"> *</small></label>
                            <div class="col-sm-9">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn cfees edit_save_button" id="load" data-action="collect" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> <?php echo $this->lang->line('processing'); ?>"><?php echo $this->lang->line('add_admi_no'); ?> </button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    //         $.ajax({
    //         url: '<?php echo site_url("admin/hallticket/admino/getadmino") ?>',
    //         type: 'post',
    //         data: {
    //             studentid: studentId,
    //         },
    ...
    //                 $('#myAdmiviewModal h4.admi_title').text(response.admi_no);
...
<script type="text/javascript">
    ...
    //     var studentid = $('#stidd').val();
    //     var admi_no  = $('#admi_noo').val();


    //     $.ajax({
    //         url: '<?php echo site_url("admin/hallticket/admino/addadminoo") ?>',
    //         type: 'post',
    //         data: {
    //             studentid: studentid,
    //             admi_no: admi_no,
    ...
    //                 location.reload();
    //             }else if (response.status === "fail") {
    //                 if (response.admi_noo) {
    //                     $('#admi_noo_error').html(response.admi_noo);
    //                 }else {
    //                     $('#admi_noo_error').html(""); // Clear any previous error messages
    //                 }
    //                 // alert("Error: " + response.error_message);
    //             }
    //         },
...
<script type="text/javascript">
    $(document).on('click', '.edit_save_button', function (e) {
        ...
        $.ajax({
            url: '<?php echo site_url("admin/hallticket/admino/addadmino") ?>',
            type: 'post',
            data: {
                studentid: studentid,
                admi_no: admi_no,
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        // Load admission numbers for all students in the table
        $('.admi_no_display').each(function() {
            var $cell = $(this);
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status === "success") {
                        $cell.html(response.admi_no);
                    } else {
                        $cell.html('<span class="text-danger">Not assigned</span>');
                    }
                },
                error: function() {
