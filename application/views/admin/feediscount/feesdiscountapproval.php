...
.fees-discount-list th,
.fees-discount-list td {
...
.fees-discount-list th:nth-child(1),
.fees-discount-list td:nth-child(1) {
    width: 30px !important;
    max-width: 30px !important;
    text-align: center;
}

.fees-discount-list th:nth-child(2),
.fees-discount-list td:nth-child(2) {
    width: 100px !important;
    max-width: 100px !important;
}

.fees-discount-list th:nth-child(3),
.fees-discount-list td:nth-child(3) {
    width: 150px !important;
    max-width: 150px !important;
}

.fees-discount-list th:nth-child(4),
.fees-discount-list td:nth-child(4) {
    width: 100px !important;
    max-width: 100px !important;
}

.fees-discount-list th:nth-child(5),
.fees-discount-list td:nth-child(5) {
    width: 120px !important;
    max-width: 120px !important;
}

.fees-discount-list th:nth-child(6),
.fees-discount-list td:nth-child(6) {
    width: 90px !important;
    max-width: 90px !important;
}

.fees-discount-list th:nth-child(7),
.fees-discount-list td:nth-child(7) {
    width: 60px !important;
    max-width: 60px !important;
}

.fees-discount-list th:nth-child(8),
.fees-discount-list td:nth-child(8) {
    width: 80px !important;
    max-width: 80px !important;
}

.fees-discount-list th:nth-child(9),
.fees-discount-list td:nth-child(9) {
    width: 100px !important;
    max-width: 100px !important;
}

.fees-discount-list th:nth-child(10),
.fees-discount-list td:nth-child(10) {
    width: 120px !important;
    max-width: 120px !important;
}

.fees-discount-list th:nth-child(11),
.fees-discount-list td:nth-child(11) {
    width: 100px !important;
    max-width: 100px !important;
}

.fees-discount-list th:nth-child(12),
.fees-discount-list td:nth-child(12) {
    width: 150px !important;
    max-width: 150px !important;
}

.fees-discount-list th:nth-child(13),
.fees-discount-list td:nth-child(13) {
    width: 100px !important;
    max-width: 100px !important;
}

.fees-discount-list th:nth-child(14),
.fees-discount-list td:nth-child(14) {
    width: 120px !important;
    max-width: 120px !important;
    text-align: center;
}
...
.fees-discount-list td .btn-group {
    display: flex;
    flex-wrap: wrap;
    gap: 2px;
}

.fees-discount-list td .btn-xs {
    font-size: 11px;
    padding: 2px 8px;
    margin: 1px;
}
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if(!response.status){
                    ...
                    // Add responsive and autoWidth settings to prevent horizontal scrolling
                    var customColumnDefs = [
                        {"orderable": false, "targets": 'no-sort'},
                        {"orderable": false, "targets": [-1], 'class': 'action'}
                    ];
                    
                    initDatatable('fees-discount-list','admin/feesdiscountapproval/dtfeesdiscountlist',response.params,[],100, customColumnDefs);
                }
            },
            error: function(xhr, status, error) {
