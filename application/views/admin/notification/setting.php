<style>
    /* High specificity to override global 'last-child' rules */
    .content-wrapper .box-body .table-responsive table.table td.message-cell {
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td width="10%"> <?php
                                                                    ...
                                                                    ?>
                                                                    <?php
                                                                    if (isset($note_value->display_whatsapp) && $note_value->display_whatsapp && !empty($note_value->whatsapp_template_id)) {
                                                                        echo "<br><small class='text-green'><i class='fa fa-whatsapp'></i> " . $note_value->whatsapp_template_id . "</small>";
                                                                    }
                                                                    ?>
                                                </td>
