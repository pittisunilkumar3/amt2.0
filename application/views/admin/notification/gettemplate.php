...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="form-group">
            <label for="whatsapp_template_id"><i class="fa fa-whatsapp text-green"></i> <?php echo $this->lang->line('whatsapp_template_id'); ?></label>
            <input type="text" id="whatsapp_template_id" name="whatsapp_template_id" class="form-control" value="<?php echo (isset($record->whatsapp_template_id)) ? $record->whatsapp_template_id : ''; ?>" placeholder="e.g., student_admission_en">
            <small class="text-muted">Enter the approved WhatsApp Cloud API template name from Meta Business Manager</small>
