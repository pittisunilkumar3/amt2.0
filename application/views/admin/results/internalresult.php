            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-header with-border">
                        <h3 class="box-title"><i class="fa fa-search"></i> <?php echo $this->lang->line('internal_result'); ?></h3>
                    </div>

                    
                    <div class="box-body">
                        <div class="row">
                            <form role="form" action="<?php echo site_url('admin/results/internalresult/search') ?>" method="post" class="">
                                ...
                                <div class="col-md-4 col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <input autofocus="" id="admission_no" name="admission_no" placeholder="" type="text" class="form-control"  value="<?php echo $admissionno;?>" />
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php 
                                                            ...
                                                            foreach($resultdata as $res){
                                                                $markdata = $this->addresult_model->getmarksid($res['markstableid'],$academicid);
