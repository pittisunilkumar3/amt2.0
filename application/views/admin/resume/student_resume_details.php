                  ...
                  <table class="table">
                   ...
                   <tbody id="append_row_reference">
                    ...
                    <tr>
                     ...
                     <td width="5%">
    					<?php if ($this->rbac->hasPrivilege('build_cv', 'can_delete')) { ?>
    					<button class="btn btn-md btn-danger rmv_reference"><?php echo $this->lang->line('remove'); ?></button>
    					<?php } ?>
    				 </td>
                    </tr>
                    <?php } } ?>
             ...
             <div class="col-md-12">
				<div class="col-md-12">
                    <div class="form-group row">
                        <label class="col-sm-3 control-label"><?php echo $this->lang->line('designation'); ?> </label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="designation" name="designation" value="<?php if(isset($student['designation'])){ echo $student['designation']; } ?>" />
				...
				<div class="col-md-12">
                    <div class="form-group row">
                        <label class="col-sm-3 control-label"><?php echo $this->lang->line('about'); ?><small class="req"> *</small> </label>
                        <div class="col-sm-9">
                            <textarea rows="15" style="min-height:250px;" class="form-control" id="about" name="about"><?php if(isset($student['about'])){ echo $student['about']; } ?></textarea>
