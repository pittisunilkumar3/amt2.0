                        ...
                        <form id="filterForm" method="post">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Section</label>
                                        <select class="form-control select2" name="section_ids[]" id="section_ids" multiple="multiple" style="width: 100%;">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2" name="feegroup_ids[]" id="feegroup_ids" multiple="multiple" style="width: 100%;">
