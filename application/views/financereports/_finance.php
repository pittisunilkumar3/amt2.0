            ...
            <div class="">
                <ul class="reportlists">
                    ...
                    <?php   }  if ($this->rbac->hasPrivilege('fees_collection_report', 'can_view')) {   ?>
                        ...
                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/total_fee_collection_report'); ?>"><a href="<?php echo base_url(); ?>financereports/total_fee_collection_report"><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('total_fee_collection_report'); ?> </a></li>
                    ...
                    <?php } if ($this->rbac->hasPrivilege('fees_collection_report', 'can_view')) {  ?>
                        ...
                        <li class="col-lg-4 col-md-4 col-sm-6 <?php echo set_SubSubmenu('Reports/finance/daysheet'); ?>"><a href="<?php echo base_url(); ?>financereports/daysheet"><i class="fa fa-calendar-check-o"></i> Fee Collection Daysheet</a></li>
