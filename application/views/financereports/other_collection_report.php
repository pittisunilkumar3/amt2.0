        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box removeboxmius">
                    ...
                    <form role="form" action="<?php echo site_url('financereports/other_collection_report') ?>" method="post" class="">
...
<div class="box-header ptbnull">
    ...
    ?>
                    <div class="">
                        <div class="box-header ptbnull"></div>
                        <div class="box-header ptbnull">
                            <h3 class="box-title titlefix"><i class="fa fa-money"></i> <?php ?> <?php echo $this->lang->line('other_fees_collection_report'); ?></h3>
                        </div>
                        ...
                        <div id="printhead"><center><b><h4><?php echo $this->lang->line('other_fees_collection_report') . "<br>";
    $this->customlib->get_postmessage();
    ?></h4></b></center></div>
                            <div class="download_label"><?php echo $this->lang->line('other_fees_collection_report') . "<br>";
    $this->customlib->get_postmessage();
    ?></div>
...
function printDiv() {
    ...
    document.body.innerHTML =
            "<html><head><title><?php echo $this->lang->line('other_fees_collection_report'); ?></title></head><body>" +
            divElements + "</body>";
    window.print();
...
var htmls = "";
        ...
        var tab_text = "<tr >";
         ...
         for (j = 0; j < tab.rows.length; j++)
         {
            ...
            link.download = "studentfee_other_fees_collection_report.xls";
