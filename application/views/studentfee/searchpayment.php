                            ...
                            <div class="col-md-12">
                                <style>
                                    .payment-search-form {
                                        ...
                                        /* Aligns the button with the input field */
                                        gap: 15px;
                                ...
                                <form role="form" action="<?php echo site_url('studentfee/searchpayment') ?>" method="post" class="payment-search-form">
                                    <?php echo $this->customlib->getCSRF(); ?>
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('payment_id'); ?> <small class="req"> *</small></label>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text text-right">
                                                    <a href="<?php echo base_url() ?>studentfee/addfee/<?php echo $feeList->student_session_id ?>" class="btn btn-primary btn-xs" data-toggle="tooltip"
