                        ...
                        <div class="row">
                            <div class="col-xs-6 text-left">
                                ...
                                <address>
                                    ...
                                    <strong><?php echo $this->customlib->getFullName($feeList->firstname, $feeList->middlename, $feeList->lastname, $sch_setting->middlename, $sch_setting->lastname); ?></strong><?php echo " (" . $feeList->admission_no . ")"; ?>
                                    <br>
                            ...
                            <div class="col-xs-6 text-right">
                                ...
                                <address>
                                    ...
                                    <strong>
                                        <?php echo $this->lang->line('payment_id'); ?>:<?php echo $feeList->id . "/" . $sub_invoice_id; ?></strong>
                                    <br />
                                        ...
                                        if (empty($feeList)) {
                                            ...
                                            <tr>
                                                ...
                                                <?php 
                                                    ...
                                                    $feetype_balance = $totalfeeList->amount - ($fee_paid + $fee_discount);
                                                ?>
                                                <td class="text text-right">
                                                    <?php
                            ...
                            <div class="col-xs-6 text-right">
                                ...
                                <address>
                                    ...
                                    <strong> <?php echo $this->lang->line('payment_id'); ?>:
                                        <?php echo $feeList->id . "/" . $sub_invoice_id; ?></strong><br>
