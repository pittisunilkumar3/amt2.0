                                            ...
                                            <tbody>
                                                <?php if (empty($student_array)) {
                                                    ...
                                                    foreach ($student_array as $student_key => $student_value) {                                                      
                                                        ...
                                                        <tr>
                                                            <th class="tdclsname">
                                                                <span data-toggle="popover" class="detail_popover" data-original-title="" title=""><a href="#" style="color:#333"><?php echo $this->customlib->getFullNamee($student_value['firstname'],$student_value['middlename'],$student_value['lastname'],$sch_setting->middlename,$sch_setting->lastname); ?></a></span>
