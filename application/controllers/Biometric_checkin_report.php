...
class Biometric_checkin_report extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->session->set_userdata('subsub_menu', 'Reports/biometric_checkin_report');
    ...
    private function build_staff_excel_content($staff_list, $statistics, $date)
    {
        ...
        $html .= '<th class="text-center">Total Hours</th>';
        ...
        foreach ($staff_list as $staff) {
            ...
            $html .= '<td class="text-center" style="color: #00a65a; font-weight: bold;">' . (isset($staff['total_hours']) ? $staff['total_hours'] : '-') . '</td>';
