...
class Additionalfeeassigns extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        //     access_denied();
        // }
        $this->session->set_userdata('top_menu', 'other_fees');
        $this->session->set_userdata('sub_menu', 'admin/additionalfeeassigns');
    ...
    public function search()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') == "GET") {
            ...
            if (isset($search)) {
                ...
                $this->form_validation->set_rules('progress_id', $this->lang->line('fee_type'), 'trim|xss_clean');
                ...
                if ($this->form_validation->run() == false) {
                    ...
                    if ($title) {
                        ...
                        $class_details = $this->class_model->get($data['class_id']);
                        $data['title'] = $this->lang->line('std_dtl_for') . ' ' . (is_array($class_details) ? $class_details['class'] : $class_details->class);
                    }
                }
            }
