...
class Hostel extends Admin_Controller
{
    ...
    public function assignhostelfeestudent()
    {
        ...
        foreach ($month_list as $key => $value) {
            $hostelfees[] = (array)$this->hostelfee_model->hostelfesstype($current_session, $value);
        }
    ...
    public function assignhostelfeepost()
    {
        ...
        $result = $this->studenthostelfee_model->add($data_insert, $student_session_id, $remove_ids, $hostel_room_id);
    ...
    public function getStudentHostelFees()
    {
        ...
        if ($student_session_id && $hostel_room_id) {
            $hostel_fees = $this->studenthostelfee_model->getStudentHostelFees($student_session_id, $hostel_room_id);
