    ...
    public function edit()
    {
        ...
        if (isset($_POST['type'])) {
            ...
            if ($_POST['type'] == 'staff_payslip') {
                ...
                $message = "admission_message";
                $header_message = "admission_header_message";
            } else if ($_POST['type'] == 'online_exam') {
                $message = 'online_exam_message';
                $header_message = 'online_exam_header_message';
            } else {
                $message = 'message1';
                $header_message = 'header_message1';
            }
        }
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data = array(
                ...
                'footer_content' => $_POST[$message], 
                'header_content' => isset($_POST[$header_message]) ? $_POST[$header_message] : "", 
            ...
            if (isset($_FILES["header_image"]) && !empty($_FILES['header_image']['name'])) {
                ...
                if ($_POST['type'] == 'student_receipt') {
                    ...
                    if ($row != '') {
                        $this->media_storage->filedelete($row, "uploads/print_headerfooter/student_receipt/");
                    }
                } else if ($_POST['type'] == 'online_admission_receipt') {
                    ...
                    if ($row != '') {
                        $this->media_storage->filedelete($row, "uploads/print_headerfooter/online_admission_receipt/");
                    }
                } else if ($_POST['type'] == 'online_exam') {
                    ...
                    if ($row != '') {
                        $this->media_storage->filedelete($row, "uploads/print_headerfooter/online_exam/");
                    }
                } else {
