...
class User extends Student_Controller
{
    ...
    public function profile()
    {
        ...
        if (!empty($student)) {
            ...
            $student_due_feeadding              = $this->studentfeemasteradding_model->getStudentFees($student_session_id);
    ...
    public function getfees()
    {
        ...
        $student_due_feeadding              = $this->studentfeemasteradding_model->getStudentFees($student_current_class->student_session_id);
    ...
    public function printpdfresume()
    {
        ...
        $stylesheet = file_get_contents(FCPATH . 'backend/resume_pdf_style.css');
