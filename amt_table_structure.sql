...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 20, 2025 at 10:34 AM
...
CREATE TABLE `biometric_timing_setup` (
  `id` int(11) NOT NULL,
  `checkin_time_start` time NOT NULL COMMENT 'Biometric check-in start time',
  `checkin_time_end` time NOT NULL COMMENT 'Biometric check-in end time',
  `checkout_time_start` time NOT NULL COMMENT 'Biometric check-out start time',
  `checkout_time_end` time NOT NULL COMMENT 'Biometric check-out end time',
